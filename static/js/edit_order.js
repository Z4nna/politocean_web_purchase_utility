...
function addItemEntry(proposal = "", project = "", manufacturer = "", manufacturerPn = "", quantity = 1) {
    ...
    div.innerHTML = `
        ...
        <input type="text" name="items_manifacturer_${itemIndex}" value="${manufacturer}" required />
        <input type="text" name="items_manifacturer_pn_${itemIndex}" value="${manufacturerPn}" required />
